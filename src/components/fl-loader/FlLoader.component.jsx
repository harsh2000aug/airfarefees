...
export default function FlLoader({ data, message }) {
    ...
    <div className="cm-section cm-fl-loader-container fl_loder">
      <div className="cm-page-center cm-txt-center">
        <div className="cm-fl-loader-wrapper box-shadow-2">
          <h4>+1-877-400-0302</h4>
          <p>{message ? message : "Let us find the best flights for you."}</p>
          <div className="cm-loader-section">
            <svg class="pl" viewBox="0 0 160 160" width="160px" height="160px" xmlns="http://www.w3.org/2000/svg">
              ...
              <g>
                <g class="pl__ring-rotate">
                  <circle class="pl__ring-stroke" cx="80" cy="80" r="72" fill="none" stroke="hsl(223,90%,55%)" stroke-width="10" stroke-dasharray="452.39 452.39" stroke-dashoffset="452" stroke-linecap="round" transform="rotate(-45,80,80)"></circle>
                </g>
              </g>
              <g mask="url(#mask1)">
                <g class="pl__ring-rotate">
                  <circle class="pl__ring-stroke" cx="80" cy="80" r="72" fill="none" stroke="hsl(193,90%,55%)" stroke-width="10" stroke-dasharray="452.39 452.39" stroke-dashoffset="452" stroke-linecap="round" transform="rotate(-45,80,80)"></circle>
                </g>
              </g>
          ...
          {data &&
            <>
              <h3 className="cm-section-sh">
                {data.locationDeparture} <i className="fa-solid fa-plane"></i> {data.locationArrival}
              </h3>
              <p className="fly-date">
